  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-navy-600">{filtered.length} { L("offres","عرض") }</p>
      </div>
        ...
        <div>
          <div className="text-center py-12 bg-navy-50 rounded-2xl">
            ...
            <h3 className="text-xl font-semibold text-navy-700 mb-2">
              { L("Inscrivez-vous en tant que chercheur d'emploi","انضم كباحث عن عمل") }
            </h3>
            <p className="text-navy-500 mb-6 max-w-md mx-auto">
              { L("Créez votre profil et recevez des offres adaptées à votre profil","أنشئ ملفك الشخصي واحصل على عروض عمل مناسبة") }
            </p>
            <a
              href="/auth"
