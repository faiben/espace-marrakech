    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-navy-500 text-sm">{ L("Rôle","الدور") }: {roleLabel[user.role] || user.role}</p>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-emerald-100 card-shadow p-5">
          ...
          <p className="text-sm text-navy-500">{ L("Rôle","الدور") }</p>
        </div>
        <div className="bg-white rounded-2xl border border-emerald-100 card-shadow p-5">
        ...
        <div className="bg-white rounded-2xl border border-emerald-100 card-shadow p-5">
          ...
          <p className="text-sm text-navy-500">{ L("Membre depuis","عضو منذ") }</p>
        </div>
      </div>
            ...
            <div>
              ...
              {myBusiness && (
                <p className="text-sm text-navy-500">
                  { lang === "ar" ? myBusiness.nameAr : myBusiness.nameFr } · <span className={clsx(
                    "font-medium",
