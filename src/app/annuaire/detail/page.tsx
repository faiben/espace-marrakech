    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="relative rounded-2xl overflow-hidden mb-6">
        {images.length > 0 ? (
          ...
          <div className="h-48 md:h-64 bg-gradient-to-br from-primary-200 to-marrakesh-light flex items-center justify-center">
        ...
        <div className="absolute bottom-4 right-4 flex gap-2">
          ...
          <button
            onClick={() => {
              ...
              if (navigator.share) {
                navigator.share({ title: lang === "ar" ? business.nameAr : business.nameFr, url });
              } else {
      ...
      {hasExtra && business.video && (
        <div className="bg-white rounded-2xl border border-emerald-100 card-shadow p-4 mb-6">
          <h3 className="font-semibold text-navy-800 mb-3 flex items-center gap-2">
            <Play size={18} className="text-primary-500" /> { L("Vidéo","فيديو") }
          </h3>
      ...
      <div className="bg-white rounded-2xl border border-emerald-100 card-shadow p-6 md:p-8">
        <div className="flex items-start justify-between gap-4 mb-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-navy-800">
              { lang === "ar" ? business.nameAr : business.nameFr }
            </h1>
        ...
        <p className="text-navy-600 mb-6">
          { lang === "ar" ? business.descriptionAr : business.descriptionFr }
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-center gap-3 p-3 bg-navy-50 rounded-xl">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-navy-700">{business.address}</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={(e) => {
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={ L("Votre commentaire (optionnel)...","تعليقك اختياري...") }
              />
            </div>
            <button
              type="submit"
